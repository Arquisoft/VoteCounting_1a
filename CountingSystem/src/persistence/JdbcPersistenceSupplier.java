...
private static Connection conexion;
	...
	public List<Voto> readResults() throws SQLException {
		...
		ResultSet rs = st.executeQuery("select o.opcion , v.idlugar , v.numvotos" +
										" from TOPCIONES o , TVOTOS v" +
		...
		while (rs.next())
		{
			...
			Voto voto = new Voto(opcion , idLugar , numVotos);
			lista.add(voto);
		}
	...
	@Override
	public List<IDictionary<KeyValuePair<String,String>,Integer>>  readStatistics() throws SQLException {
		Statement st = conexion.createStatement();
		ResultSet rs = st.executeQuery("select o.opcion , l.ciudad , v.numvotos" +
										" from TOPCIONES o , TVOTOS v , TLUGARES l" +
										" where o.id = v.idopcion and v.idlugar = l.id;");
